...
- [x] 02-01-PLAN.md — Publish strict versioned manifests with verified snippet and whole-grid stored-byte evidence
...
- [x] 03-01-PLAN.md — Restore one explicitly previewed project only after verified automatic recovery

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03-02-PLAN.md — Protect both sides of swap and route local instrument actions through complete recovery

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-03-PLAN.md — Replace a complete grid exactly and pass direct mounted project/grid acceptance
...
- [x] 06-01-PLAN.md — Gate automatic delete-project-file clearing behind fixture and sacrificial-device acceptance
...
| 6. Hardware-Gated Automatic Clearing | 1/1 | In Progress|  |
